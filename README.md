...
본 프로젝트는 Claude의 코드를 기준으로 작성되었으며, 
AI와의 효율적인 협업 및 일관성 있는 코드 생성을 위해 
백엔드 claude.md 규칙을 정의하고 있습니다.
### 1. 루트 컨벤션 (./claude.md)
...
### 3. 프론트엔드 컨벤션 (./front-end/claude.md)
 * React 및 MFE(Micro Frontends) 환경에서 독립적인 컴포넌트 개발 및 컨테이너(Host) 앱과의 연동을 위한 프롬프트 규칙을 정의합니다.
 * 상태 관리, 컴포넌트 분할, CSS-in-JS 등의 작성 표준을 ## 🛠️ 기술 스택 (Tech Stack)
### 백엔드 (Back-end)
 * **명칭:** asset-control
 * **언어 및 프레임워크:** Kotlin / Spring Boot (기반)
 * **데이터베이스:** PostgreSQL (pg)
